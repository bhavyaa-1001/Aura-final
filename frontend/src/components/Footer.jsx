      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            >
              <h3 className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">AURA</h3>
              <p className="text-slate-300 text-sm">
                Agentic Unified Regulatory Architecture - Simplifying compliance for industrial licensing and approvals.
              </p>
          ...
          <div className="col-span-1">
            ...
            >
              ...
              <p className="text-slate-300 text-sm">Email: info@aura-platform.com</p>
              <p className="text-slate-300 text-sm">Phone: +1 (555) 123-4567</p>
              <p className="text-slate-300 text-sm">Address: 123 Tech Park, Innovation District, CA 94103</p>
            </motion.div>
          </div>
        </div>
